...
const Header = () => {
  return (
    <header className="sticky top-0 border border-techit-gray-100 font-pretendard bg-white z-10">
        ...
        <div className="flex items-center">
          ...
          <nav className="hidden lg:flex">
            ...
            <span className="relative">
              ...
              <div className="absolute top-2 left-0 bg-[#ef4444] w-4 h-4 rounded-full text-[10px] text-white font-semibold flex justify-center items-center">
                N
              </div>
            </span>

            <button className="nav-button-style">이벤트</button>
            <span className="border-l border-[rbg(229,229,229)] h-5 self-center" />

            <button className="nav-button-style">기업 해커톤</button>
          </nav>
        </div>
        <div className="flex pr-2 lg:pr-0">
          <button className="px-4 lg:px-6 py-2 lg:py-5 font-semibold text-Techit_gray-300 lg:text-Techit_gray-300 text-sm lg:text:base border border-Techit_gray-100 lg:border-0 rounded-full lg:rounded-none">
            로그인
          </button>
          <svg
